...
/// The private per-stage entrypoints the stage tests launch.
///
/// One entrypoint per stage of the step -- projection, routed experts, shared
/// experts -- each launching the same stage body the production kernel runs.
/// They exist so a stage can be checked against its reference in isolation,
/// and nothing public reaches them.
