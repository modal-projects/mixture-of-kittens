...
PYBIND11_MODULE(TORCH_EXTENSION_NAME, m) {
    ...
    m.def("_kimi_k3_route_finalize_workspace_bytes",
          &kimi_k3_decode::kimi_k3_route_finalize_workspace_bytes);
    m.def("_kimi_k3_route_finalize",
          &kimi_k3_decode::kimi_k3_route_finalize_entrypoint, "",
          pybind11::arg("hidden_states"),
