...
PYBIND11_MODULE(TORCH_EXTENSION_NAME, m) {
    ...
    // PRIVATE BENCHMARK-ONLY: transformed fused-W13 full-step candidate.
    // The entrypoint itself also requires its dedicated environment guard.
    m.def("_kimi_k3_decode_fused_w13_benchmark",
          &kimi_k3_decode::kimi_k3_decode_fused_w13_benchmark_entrypoint, "",
          pybind11::arg("hidden_states"),
          pybind11::arg("router_weight"),
          pybind11::arg("router_correction_bias"),
          pybind11::arg("routed_expert_down_proj"),
          pybind11::arg("routed_expert_up_proj"),
          pybind11::arg("routed_latent_rmsnorm_weight"),
          pybind11::arg("expert_w13_packed"),
          pybind11::arg("expert_w13_scale"),
