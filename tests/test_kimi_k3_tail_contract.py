...
symmetric pointer topology every rank must supply, the signature that binds that
topology to one workspace, and the shared barrier pair across the unsigned wrap.
What the launch computes is covered in
